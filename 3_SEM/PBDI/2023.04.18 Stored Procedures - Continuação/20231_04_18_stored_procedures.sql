--criar pedido, como se o cliente entraasse no restaurante e pegasse a comida
...
-- 	--LASTVAL é uma função de PostgreSQL que obtém o último valor gerado pelo mecanismo serial
...
-- 	CONSTRAINT fk_tipo_iem FOREIGN KEY(cod_tipo) REFERENCES tb_tipo_item(cod_tipo)
-- );
...
-- INSERT INTO tb_tipo_item (descricao) VALUES ('Bedida'), ('Comida');
...
-- 	CONSTRAINT fk_client FOREIGN KEY(cod_cliente) REFERENCES tb_cliente(cod_cliente)
-- );
